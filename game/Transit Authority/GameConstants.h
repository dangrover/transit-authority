...
#define GAME_STATION_BOARDING_TIME_IN_GAME_SECONDS 35
#define GAME_PASSENGER_BOARDING_TIME_IN_GAME_SECONDS 4
...
#define GAME_STATION_POI_SURCHARGE 10000 // How much extra to pay if we're connecting to a POI?
#define GAME_TRACK_COST_PER_TILE 1200
#define GAME_BRIDGE_COST_PER_TILE 1500
